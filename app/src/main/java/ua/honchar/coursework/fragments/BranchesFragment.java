...
public class BranchesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private RequestQueue requestQueue;
    private RecyclerView recyclerView;
    private SwipeRefreshLayout refreshLayout;
    private String table = "branches";
    private final String URL = "https://kayzersproject.000webhostapp.com/server/get_branches.php";
