...
import ua.honchar.coursework.DetailContractActivity;
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    adapter.setListener(position -> {
                            Intent intent = new Intent(getContext(), DetailContractActivity.class);
                            intent.putExtra(DetailContractActivity.POSITION, position);
