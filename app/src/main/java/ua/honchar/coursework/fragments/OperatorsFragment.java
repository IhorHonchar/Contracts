...
public class OperatorsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private RequestQueue requestQueue;
    private RecyclerView recyclerView;
    private SwipeRefreshLayout refreshLayout;
    private String table = "operators";
    private final String URL = "https://kayzersproject.000webhostapp.com/server/get_operators.php";
